...
test('upgrade laptop to macbook', () => {
    let user: UserWitchLaptopType & UserWithBooksType = {
        name: 'Dimych',
        hair: 32,
        address: {
            city: 'Minsk',
...
test('remove company', () => {
    let user: UserWitchLaptopType & WithCompaniesType = {
        name: 'Dimych',
        hair: 32,
        address: {
            city: 'Minsk',
    ...
    const userCopy = updateCompanyTitle(user, 1, 'EPAM') as UserWitchLaptopType & WithCompaniesType
